(function () {
    angular
        ...
        .controller('RetailerListController', RetailerListController);

    RetailerListController.$inject = ['$state', '$scope', '$uibModal', '$timeout', 'FruitsRetailerService', 'uiGridConstants'];

    function RetailerListController($state, $scope, $uibModal, $timeout, FruitsRetailerService, uiGridConstants) {
        ...
        vm.gridOptions = {
            ...
            columnDefs: [
                ...
                {
                    name: ' ', width: 120, enableFiltering: false, cellTemplate: '<div style="text-align:center;padding-top:3px;"><a ng-click="grid.appScope.EditRetailer(row.entity)" style="margin-right:3px;" class="btn btn-warning btn-xs">Edit</a></div>'
                }
            ],
        };
        ...
        {
            $state.go('editretailer', { retailer: { Id: entity.Id, Name: entity.Name, AccountNumber: entity.AccountNumber, Address: entity.Address, MobileNumber: entity.MobileNumber } });
        }
        

        $scope.DeleteRetailer = function (entity)
        {
            var setting = {
                Id: entity.Id
            };
