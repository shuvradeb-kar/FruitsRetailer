(function () {
    ...
    EditCashBookController.$inject = ['$state', '$scope', 'FruitsRetailerService', '$stateParams'];

    function EditCashBookController($state, $scope, FruitsRetailerService, $stateParams) {
        var vm = this;
